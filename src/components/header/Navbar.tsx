    ...
    <>
      <div className="max-w-4xl container mx-auto px-4 py-2 fixed top-0 left-0 right-0 backdrop-blur-md bg-white/30     ">
        <div className="flex justify-between items-center mt-2">
          <div className="lg:m-2  text-center ">
          ...
          <div className="max-w-[120px] w-full">
            <Link
              className="bg-blue-500 max-w-[150px] ring-4 ring-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 flex justify-center items-center gap-2 rounded-xl shadow-shadow hover:shadow-inner duration-75 ease-in-out shadow-black text-md "
              target="_blank"
              title="Download CV"
              to={Cv}
            >
        ...
        <nav className="flex py-2 font-semibold px-2">
          <ul className="flex justify-between w-full border-b-2 border-gray-400 border-dashed py-2 px-2 mt-4">
