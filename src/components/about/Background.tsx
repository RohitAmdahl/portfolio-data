  ...
  return (
    <>
      <div className="p-4">
        ...
        <p>
          I am proficient in using Architerra for generating 3D terrain,
          utilizing x and y coordinates based on the Norwegian maps coordinate
          system. Furthermore, I have leveraged cutting-edge technology,
          including drones like DJI Go, to fly over buildings and capture aerial
          data. With tools like DroneDeploy, I've transformed this data into
          detailed 3D models and conducted precise measurements, showcasing my
          passion for integrating technology into architectural practice.
        </p>
